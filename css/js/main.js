...
/* ============================================================
   ADD HEADER SOCIAL LINKS TO EVERY PAGE
   ============================================================ */
...
(function addHeaderSocialLinks() {
  ...
  const hireButton = nav.querySelector('.nav-cta');
  ...
  social.innerHTML = `
    ...
    >
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
        <path d="M12 2A10 10 0 0 0 8.84 21.49c.5.09.68-.22.68-.48v-1.69c-2.78.6-3.37-1.34-3.37-1.34a2.64 2.64 0 0 0-1.11-1.46c-.91-.62.07-.61.07-.61a2.1 2.1 0 0 1 1.53 1 2.15 2.15 0 0 0 2.94.84 2.15 2.15 0 0 1 .64-1.35c-2.22-.25-4.55-1.12-4.55-4.94a3.87 3.87 0 0 1 1-2.69 3.6 3.6 0 0 1 .1-2.65s.84-.27 2.75-1a9.47 9.47 0 0 1 5 0c1.91-1.29 2.75-1 2.75-1a3.6 3.6 0 0 1 .1-2.65A10 10 0 0 0 12 2Z"/>
      </svg>
    </a>
  ...
  /* Put icons directly before the existing HIRE ME button */
